...
#               sec min hour week day month year
    ...
    def set_time(self,new_time):
        ...
        week = "0" + str(self.weekdays.index(new_time.split(",",2)[1])+1)
    ...
    def read_time(self):
        ...
        min = t[1]&0x7F  #minute
        hour = t[2]&0x3F  #hour
        weekday = t[3]&0x07  #week
        day = t[4]&0x3F  #day
        month = t[5]&0x1F  #month
        year = t[6]&0xFF  #year
        print("20%x/%02x/%02x %02x:%02x:%02x %s %s" %(year,month,day,hour,min,sec,self.weekdays[weekday-1], self.months[month-1]))
        print(f"{day} {self.months[month-1]} 20{year:02x} at {hour:02x}:{min:02x}:{sec:02x}")
...
if __name__ == '__main__':
    ...
    #rtc.set_time('19:28:50,Thursday,2025-03-13')
    rtc.read_time()
